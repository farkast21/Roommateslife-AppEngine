 ...
 * the License.
 */
package hu.roommateslife.client;
...
import hu.roommateslife.client.MyRequestFactory.HelloWorldRequest;
import hu.roommateslife.client.MyRequestFactory.MessageRequest;
import hu.roommateslife.shared.MessageProxy;

public class RoommateslifeWidget extends Composite {
  ...
  interface RoommateslifeUiBinder extends UiBinder<Widget, RoommateslifeWidget> {
  }

  private static RoommateslifeUiBinder uiBinder = GWT.create(RoommateslifeUiBinder.class);
